      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hypermusic, 55 rue des dev.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hypermusic, accessible from{" "}
            <a
              href="www.hypermusic.com"
